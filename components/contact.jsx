...
export default function Contact() {
  return (
    <section id="iletisim" className=" text-[#2e2e2e] py-17 sm:py-20 px-4 font-sans sm:px-6 bg-[#FAFAFA] overflow-x-hidden">
      <div className="max-w-5xl mx-auto text-center">
        <h2 className="text-3xl sm:text-4xl font-bold mb-4 mt-4 sm:mt-6">İletişim</h2>
