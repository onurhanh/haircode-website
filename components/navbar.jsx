    ...
    >
      <div className="lg:max-w-7xl mx-auto py-4 px-8 md:px-14 lg:px-4 flex justify-between items-center relative">
        ...
        <div className='absolute left-1/2 transform -translate-x-1/2 transition-opacity duration-300'>
          {showLogo ? (
            <span className="text-white text-xl sm:text-4xl font-bold">HAIR CODE</span>
          ) : (
            <span className="text-white text-xl sm:text-4xl font-bold">HAIR CODE</span>
          )}
        </div>
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="lg:hidden flex flex-col bg-black text-white px-4 py-4 space-y-3 text-base w-full max-w-full z-50"
          >
